 ...
 */
function buildSourceCodes(input) {
    const embeddedJSs = (0, yaml_1.parseAwsFromYaml)(input.fileContent);
    ...
    for (const embeddedJS of embeddedJSs) {
        ...
        try {
            const sourceCode = (0, jsts_1.buildSourceCode)(jsTsAnalysisInput, 'js');

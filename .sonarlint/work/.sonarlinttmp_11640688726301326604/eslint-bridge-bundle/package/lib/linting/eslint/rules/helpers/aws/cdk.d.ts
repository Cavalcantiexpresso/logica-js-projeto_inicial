...
export declare type AwsCdkCallback = {
    functionName?: string;
    methods?: string[];
...
export declare type AwsCdkConsumer = ((expr: estree.NewExpression, ctx: Rule.RuleContext) => void) | AwsCdkCallback;
declare type Values = {
    invalid?: any[];
    valid?: any[];
    case_insensitive?: boolean;
};
declare type ValuesByType = {
    primitives?: Values;
    fqns?: Values;
    customChecker?: (ctx: Rule.RuleContext, node: estree.Node) => boolean;
};
export declare type AwsCdkConsumerMap = {

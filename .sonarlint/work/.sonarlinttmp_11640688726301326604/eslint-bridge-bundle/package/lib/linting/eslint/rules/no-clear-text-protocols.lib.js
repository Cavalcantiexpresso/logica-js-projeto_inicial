...
exports.rule = {
    ...
    create(context) {
        ...
        function usesSesCommunication(sesProperty) {
            ...
            if (!ses || !(0, helpers_1.isCallToFQN)(context, ses, '@aws-sdk/client-ses', 'SES')) {
                return false;
            }
            const aws = (0, helpers_1.getObjectExpressionProperty)(configuration, 'aws');
            if (!aws || ((_b = (0, helpers_1.getModuleNameOfNode)(context, aws.value)) === null || _b === void 0 ? void 0 : _b.value) !== '@aws-sdk/client-ses') {
                return false;
            }
            return true;
        }

...
function isException(context, node, name) {
    ...
    // handle require
    let { module } = (0, helpers_1.getModuleAndCalledMethod)(node, context);
    // handle import
    if (module === undefined) {
        module = (0, helpers_1.getModuleNameOfIdentifier)(context, identifierFromModule);
    }
    if ((module === null || module === void 0 ? void 0 : module.value) === 'vue') {
        return true;
    }
    const moduleOfImport = (0, helpers_1.getModuleNameOfImportedIdentifier)(context, identifierFromModule);
    if (name === 'Grid' && (moduleOfImport === null || moduleOfImport === void 0 ? void 0 : moduleOfImport.value) === '@ag-grid-community/core') {
        return true;
    }
    return false;
}

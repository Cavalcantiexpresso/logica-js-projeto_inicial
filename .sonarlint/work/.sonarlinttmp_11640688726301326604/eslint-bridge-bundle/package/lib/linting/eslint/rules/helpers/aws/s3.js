...
function isS3BucketConstructor(context, node) {
    const { module, method } = (0, __1.getModuleAndCalledMethod)(node.callee, context);
    return (module === null || module === void 0 ? void 0 : module.value) === 'aws-cdk-lib/aws-s3' && (0, __1.isIdentifier)(method, 'Bucket');
}
...
function isS3BucketDeploymentConstructor(context, node) {
    const { module, method } = (0, __1.getModuleAndCalledMethod)(node.callee, context);
    return (module === null || module === void 0 ? void 0 : module.value) === 'aws-cdk-lib/aws-s3' && (0, __1.isIdentifier)(method, 'BucketDeployment');
}

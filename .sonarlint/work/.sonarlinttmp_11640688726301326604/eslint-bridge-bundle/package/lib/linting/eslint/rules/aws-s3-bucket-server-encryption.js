...
exports.rule = (0, s3_1.S3BucketTemplate)((bucket, context) => {
    ...
    function isUnencrypted(encrypted) {
        return (0, helpers_1.hasFullyQualifiedName)(context, encrypted, 'aws-cdk-lib/aws-s3', 'BucketEncryption', 'UNENCRYPTED');
    }
}, {
    meta: {
        schema: [
...
//# sourceMappingURL=aws-s3-bucket-server-encryption.js.map
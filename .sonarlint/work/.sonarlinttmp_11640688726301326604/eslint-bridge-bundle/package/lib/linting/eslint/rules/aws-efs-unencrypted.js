...
exports.rule = (0, cdk_1.AwsCdkTemplate)({
    'aws-cdk-lib.aws_efs.FileSystem': (0, cdk_1.AwsCdkCheckArguments)('FSEncryptionDisabled', false, 'encrypted', { primitives: { invalid: [false] } }),
    'aws-cdk-lib.aws_efs.CfnFileSystem': (0, cdk_1.AwsCdkCheckArguments)(['CFSEncryptionOmitted', 'CFSEncryptionDisabled'], true, 'encrypted', { primitives: { valid: [true] } }),
}, {
    meta: {
        messages: {
...
//# sourceMappingURL=aws-efs-unencrypted.js.map
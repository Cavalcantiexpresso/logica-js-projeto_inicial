    ...
    create(context) {
        ...
        return {
            ...
            AssignmentExpression: (node) => {
                ...
                if (!((isMustacheModule(context, left.object) || isMustacheIdentifier(left.object)) &&
...
function isMustacheIdentifier(node) {
    return (0, helpers_1.isIdentifier)(node) && node.name === 'Mustache';
}
function isMustacheModule(context, node) {
    const module = (0, helpers_1.getModuleNameOfNode)(context, node);
    return (module === null || module === void 0 ? void 0 : module.value) === 'mustache';
}

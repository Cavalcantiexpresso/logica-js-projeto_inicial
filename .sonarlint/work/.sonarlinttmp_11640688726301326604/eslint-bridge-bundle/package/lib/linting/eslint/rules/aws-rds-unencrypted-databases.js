...
function checkStorage(storage) {
    return (expr, ctx) => {
        ...
        function isUnresolved(node, value) {
            return (node === null || node === void 0 ? void 0 : node.type) === 'Identifier' && !(0, helpers_1.isUndefined)(node) && value === undefined;
        }
...
//# sourceMappingURL=aws-rds-unencrypted-databases.js.map
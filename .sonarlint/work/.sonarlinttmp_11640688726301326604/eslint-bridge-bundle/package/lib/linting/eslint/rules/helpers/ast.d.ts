...
export declare type Node = estree.Node | TSESTree.Node;
...
export declare type StringLiteral = estree.Literal & {
    value: string;
};
...
export declare function getValueOfExpression<T extends Node['type']>(context: Rule.RuleContext, expr: Node | undefined | null, type: T, recursive?: boolean): Extract<Node, {
    type: T;
}> | undefined;
/**
